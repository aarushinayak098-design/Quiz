  ...
  return (
    <Container maxWidth="lg" sx={{ py: 6 }}>
      ...
      >
        ...
        >
          {user?.role === 'admin' ? 'Client Quiz Library' : 'Available Quizzes'}
        </Typography>
        <Typography variant="body1" align="center" color="text.secondary" sx={{ mb: 4 }}>
          {user?.role === 'admin'
            ? 'Admins can open the client side to preview quiz experiences.'
            : 'Choose a quiz below and begin your attempt.'}
        </Typography>
      </motion.div>
